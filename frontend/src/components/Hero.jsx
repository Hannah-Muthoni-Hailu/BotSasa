...
export default function Hero() {
    return(
        <Container fluid className="d-md-flex flex-row-reverse mt-3">
            <div className="d-flex w-75 mx-auto">
                <img src={hero} alt="image showing a pdf's content being input into a chatbos" className=" mx-md-0 m-auto w-100 align-self-center" />
            </div>
            <div className='pt-l-5 ps-2 mt-2 mt-md-5 text-md-start text-center'>
                ...
                <Link to="/signup" state={{ isSigningUp: 'true' }} className='mx-1'>
                    <Button className="btn-filled me-md-2 mb-2 mb-md-0" style={{ 'width': '150px' }}>Get started</Button>
                </Link>
                <a href="#pricing">
